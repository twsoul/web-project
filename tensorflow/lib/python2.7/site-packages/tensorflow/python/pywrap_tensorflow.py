...
class PyCheckpointReader(CheckpointReader):
    __swig_setmethods__ = {}
    for _s in [CheckpointReader]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, PyCheckpointReader, name, value)
    __swig_getmethods__ = {}
    for _s in [CheckpointReader]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, PyCheckpointReader, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    def _GetTensor(self, *args): return _pywrap_tensorflow.PyCheckpointReader__GetTensor(self, *args)
...
def _NewPyCheckpointReader(*args):
  return _pywrap_tensorflow._NewPyCheckpointReader(*args)
