...
$(document).ready(function(){
    $("#id_enter").blur(function(){ //포커스 나갔을 때
        $.ajax({ //ajax로 보낸다.
...
<div class="container">
 ...
 <!-- 포스트로 id/pw/pw확인/각오 보내고 -->
<form id="form" method="post" enctype="multipart/form-data" class="form-horizontal" style="margin: 0 100px 0 100px;border: solid 1px;border-radius:4px">
	<table class="table table-responsive">
    <tr>
        <? $r1 = rmd5(rand().mocrotime(TRUE)); ?>
    	<td><label class="control-label">아이디</label></td>
        <td><input id="id_enter" class="form-control" type="text" name="<? echo $r1; ?>" placeholder="아이디를 입력하세요." autocomplete="off" readonly
    onfocus="this.removeAttribute('readonly');" />
            <input type="hidden" name="__autocomplete_fix_<? echo $r1; ?>" value="newusername" />

            <!-- <span id="id_form"></span> -->
        </td>
    ...
    <tr>
        ...
        <td>
            ...
            <!-- <span class="control-label">비밀번호 형식</span> -->
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <!-- <span class="control-label">비밀번호 일치 확인</span> -->
        </td>
    </tr>

    <tr>
        <? $r4 = rmd5(rand().mocrotime(TRUE)); ?>
    	<td><label class="control-label">각오</label></td>
        <td><input class="form-control" type="text" name="<? echo $r4; ?>" placeholder="각오 한마디" autocomplete="off" readonly
    onfocus="this.removeAttribute('readonly');" />
    ...
    <tr>
        ...
        <button type="submit" name="submit"  class="btn btn-primary"><span class="glyphicon glyphicon-floppy-save"></span>&nbsp; 가입</button>
        </td>
    </tr>
    </table>
</form>
