...
<form id="myform" method="post" enctype="multipart/form-data" class="form-horizontal" style="margin: 0 300px 0 300px;border: solid 1px;border-radius:4px">
    ...
    <tr>
        ...
        ?>
        <input id="pw" class="form-control" type="text" name="<? echo $r2; ?>" value="<?php echo $decrypted_password; ?>" placeholder="패스워드를 입력하세요."
    ...
    <tr>
    	...
    	<td><label class="control-label">각오 한마디</label></td>
        <td>
        <input class="form-control" type="text" name="<? echo $r3; ?>" value="<?php echo $userprofile; ?>" placeholder="각오."
               autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" required />
